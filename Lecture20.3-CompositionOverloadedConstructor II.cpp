...
Employee::Employee(char* empName, char* rank, Date birthDay, Date joinDate)
{
	dob = birthDay;
	...
	cout << "\n\nEmployee Overloaded Constructor Called for\n";
	PrintInfo();
}
Employee::~Employee()
{
...
void main()
{
	...
	cout << "\n\n\n\nBoss Information:\n";
	boss.PrintInfo();
	cout << "Going to pop Activation record of main().\n\n";
}